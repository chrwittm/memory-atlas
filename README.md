...
[0.3.0 is available as an unnotarized tester prerelease](https://github.com/chrwittm/memory-atlas/releases/tag/v0.3.0).
It is the verified navigation and map release described below.
...
The [release notes](RELEASE_NOTES.md) describe the public 0.3.0 navigation and
map release, the 0.2.2 security replacement, and historical local builds.
